...
// adding favorites to firebase section
  ...
  const rndIndexValues = (num1, num2, numOfValues) => {
  	let arrayOfRndIndex = [];

    for (let i = 0; i < numOfValues; i++) {
      arrayOfRndIndex.push(Math.floor(Math.random() * (num2 - num1 + 1)) + num1);
    }
    return arrayOfRndIndex;
  };
  ...
  return {
    ...
    getPictures, assignId, getPictureObj, addToFavoritesList, rndIndexValues
  };
